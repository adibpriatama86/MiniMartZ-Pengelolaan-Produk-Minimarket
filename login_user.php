...
if (isset($_POST["submit"])) {
    ...
    if ($pesan_error === "") {
        ...
        header("Location: daftar_produk_user.php");
    }
} else {
...
<head>
    <meta charset="UTF-8">
    <title>MiniMartZ - Login User</title>
...
<body>
    <div class="container">
        ...
        <h3 class="judul">Login sebagai User</h3>
        <?php
        ...
        <form action="login_user.php" method="post">
            ...
            <p>
                <a href="register_user.php">Belum punya akun? Daftar Sekarang</a>
            </p>
            <p>
